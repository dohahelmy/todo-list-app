...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		// TODO: write test ===> test written DOHA
	...
	it('should highlight "All" filter by default', function () {
		// TODO: write test ====> test written DOHA
		var todo = {id: 42, title: 'my todo', highlited:true};
		setUpModel([todo]);
	...
	it('should highlight "Active" filter when switching to active view', function () {
		// TODO: write test ====> test written DOHA
		var todo = {id: 42, title: 'my todo', active: true, highlited: true};
		setUpModel([todo]);
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			...
			subject.setView('');
			model.remove({id: 21}, function(){} );

			expect(model.remove).toHaveBeenCalledWith({id: 21}, jasmine.any(Function));
		});
